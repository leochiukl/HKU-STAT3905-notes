...
the future (known as \defn{delivery date} or \defn{maturity}) for a specified
...
\faIcon{apple-alt} at time \(t\)\footnote{In this notes, we shall assume one
can freely buy or sell any amount of \faIcon{apple-alt} at time \(t\) in the
