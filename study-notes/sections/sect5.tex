...
\begin{enumerate}
\item An \defn{option spread} consists of long/short call/put options on the
same underlying asset \faIcon{apple-alt}, with the same expiration date and
exercise style, but with different strike prices (the strike prices are
``spread'' out).
...
\end{note}
\todo{explain spread in butterfly spread}
\end{enumerate}
