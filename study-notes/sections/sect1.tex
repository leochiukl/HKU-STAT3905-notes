...
other more basic underlying variable(s) (e.g., total rainfall \faIcon{cloud-rain}
...
\faIcon{fire-alt} (known as \defn{hedging}) (example: insurance);
...
\begin{enumerate}
\item Borrow the instrument \faIcon{scroll} from a third party (e.g. broker) \faIcon{landmark}.
\item Sell the instrument \faIcon{scroll} to the market \faIcon{network-wired}
for cash \faIcon{dollar-sign} (creating a \emph{short position}).
\item Use the cash \faIcon{dollar-sign} to buy \faIcon{scroll} some time later
\faIcon{clock} and return \faIcon{scroll} to the lender \faIcon{landmark}
...
return the instrument \faIcon{scroll} when its price surges in the future.
\end{note}
